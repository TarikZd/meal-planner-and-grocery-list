...
- **Formula 2.0 Mastery:** Utilize Formulas 2.0 for all dynamic data. Automatically link Meal Plans to a Grocery List using Relations and Rollups; calculate weekly calorie totals and grocery completion rates.
- **Button Automations:** Every template must include UX-enhancing buttons (e.g., "Add Meal," "Add Grocery Item," "Mark Bought").
...
## 🧭 Product Directive: Meal Planner & Grocery List

- **Template Name:** Meal Planner and Grocery List
- **SEO Targets:** `notion meal planner`, `grocery list notion template`, `weekly meal plan notion`, `free meal planner notion`, `notion food tracker`
- **Price Point:** Free (lead magnet)
- **Brand:** Moorish Dev | Logo: `assets/moorish_dev_logo.png`
- **Target Audience:** Health-conscious individuals, meal preppers, and busy families who want to simplify their weekly cooking routine inside Notion.
- **Core Requirement:** Duplicate and start meal planning in under 60 seconds.
